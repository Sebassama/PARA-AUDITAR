// app/secretary/page.tsx (🎨 UI MEJORADA + 🔒 SEGURIDAD COMPLETA)
'use client'
          ...
          <CardContent className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                ...
                <br /><br />
                <strong>Roles permitidos:</strong> {ALLOWED_ROLES.join(', ')}
              </AlertDescription>
            </Alert>
            <Alert>
    ...
    return (
      <div className="max-w-4xl mx-auto py-10">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-2xl font-bold mb-1">Panel de Secretaría</h1>
        ...
        <TitleForm wallet={session.wallet} />
      </div>
    )
  }
