// app/groups/page.tsx (🎨 UI MEJORADA + 🔒 SEGURIDAD COMPLETA)
'use client'
...
export default function GroupsPage() {
  const {
    ...
    signOut,
    expectedWallet
  } = useMicrosoftAuth(REQUIRED_ROLES)
  ...
  // 🎨 PANTALLA: Rol no autorizado (MEJORADA)
    ...
    return (
      <div className="max-w-4xl mx-auto py-10">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-2xl font-bold mb-1">Panel de Grupos Académicos</h1>
        ...
        <CertificadoUpload wallet={session.wallet} />
      </div>
    )
  }
